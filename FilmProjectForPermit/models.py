...
class FilmProjectForPermit(models.Model):
    FilmProjectForPermit_Cast = models.ForeignKey(settings.AUTH_USER_MODEL ,related_name='filmprojectforpermitscast', on_delete=models.CASCADE)
    FilmProjectForPermit_Category = models.CharField(max_length=100)
    FilmProjectForPermit_Client = models.ForeignKey(settings.AUTH_USER_MODEL ,related_name='filmprojectforpermitsclient', on_delete=models.CASCADE)
    ...
    FilmProjectForPermit_PermitLocationList = models.ForeignKey(Location, related_name='filmprojectforpermitslocationlist', on_delete=models.CASCADE)
