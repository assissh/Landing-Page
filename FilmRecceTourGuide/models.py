...
class FilmRecceTourGuide(models.Model):
    ...
    FilmRecceTourGuide_FilmLocationFromGuided = models.ForeignKey(Location_Category, related_name='filmreccetourguidesLocationguide', on_delete=models.CASCADE)
    FilmRecceTourGuide_Passing_Year = models.CharField(max_length=100)
    FilmRecceTourGuide_guidedlocation_List = models.ForeignKey(Location, related_name='filmreccetourguidesLocation', on_delete=models.CASCADE)
