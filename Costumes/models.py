...
class Costume(models.Model):
    ...
    Costume_Image = models.ForeignKey(Image, related_name='CostumesImage', on_delete=models.CASCADE)
...
class Comment(models.Model):
    ...
    Comment_Costume = models.ForeignKey(Costume,related_name='CostumeComment', null=False, on_delete=models.CASCADE)
    Costume_Comment_Author = models.ForeignKey(settings.AUTH_USER_MODEL, related_name = 'CostumeComments', on_delete=models.CASCADE)
