...
class Quick_Requirements(models.Model):
    Quick_Requirements_Category = models.ForeignKey(Location_Category,related_name='category', on_delete=models.CASCADE,null=True)
    ...
    Quick_Requirements_Pitch_List = models.ForeignKey(LocationPitch,related_name='pitchlist', on_delete=models.CASCADE,null=True)
    ...
    Quick_Requirements_Sub_Category = models.ForeignKey(LocationSubCategory,related_name='locationsubcategory', on_delete=models.CASCADE,null=True)
