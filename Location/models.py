...
class Location(models.Model):
    ...
    Location_Comment = models.ForeignKey(Comments, related_name='locations', on_delete=models.CASCADE,null=True)
    Location_Description = models.CharField(max_length=100)
    Location_District = models.CharField(max_length=100)
    Location_Images = models.ForeignKey(Image, related_name='locations', on_delete=models.CASCADE,null=True)
    Location_Locality = models.CharField(max_length=100)
    Location_Name = models.CharField(max_length=100)
    Location_Postal_Address = models.CharField(max_length=100)
    Location_Category = models.ForeignKey(Location_Category, related_name='locations', on_delete=models.CASCADE,null=True)
    ...
    Location_Profile_Project = models.ForeignKey(ProfileProjects , related_name='locations', on_delete=models.CASCADE,null=True)
    Location_Rating = models.ForeignKey(Rating, related_name='locations', on_delete=models.CASCADE,null=True)
    Location_Restrictions = models.CharField(max_length=100)
    Location_Shooting_Aminities = models.ForeignKey(Location_Amenitie,related_name='LocationAmenities',on_delete=models.CASCADE,null=True)
    Location_State = models.CharField(max_length=100)
    Location_Street_Address = models.CharField(max_length=100)
    Location_Surrounding = models.CharField(max_length=100)
    Location_Video = models.ForeignKey(Video, related_name='locations', on_delete=models.CASCADE,null=True)
